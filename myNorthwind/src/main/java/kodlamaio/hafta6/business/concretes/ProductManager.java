...
public class ProductManager implements ProductService{
	...
	public DataResult<List<Product>> getAll(int pageNo, int pageSize) {
		...
		return new SuccessDataResult<List<Product>>(this.productDao.findAll(pageable).getContent(),"Sayfalar Getirildi");
	}
	...
	public DataResult<List<Product>> getAllSorted() {
		...
		return new SuccessDataResult<List<Product>>(this.productDao.findAll(sort),"İşlem Başalarılı");
	}
